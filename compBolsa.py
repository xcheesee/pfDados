...
plt.suptitle('Grafico 14 -- Relação entre Latrocinio e Verba Gasta em Bolsa Familia(por Estado)')
plt.title('\n'.join(pltTitle))
...
#plt.suptitle('Grafico 13 -- Relação entre Taxa de Latrocinio e Numero de Pessoas Beneficiadas pelo Bolsa Familia(por Estado)')
#plt.title('\n'.join(pltTitle))
#
#plt.legend()
#plt.grid(True)
...
#plt.xlabel('Verba Gasta em Bolsa Familia')
#plt.suptitle('Grafico 8 -- Relação entre Taxa de Trafico e Verba Gasta em Bolsa Familia(por Estado)')
#plt.title('\n'.join(pltTitle))
#
#plt.legend()
#plt.grid(True)
